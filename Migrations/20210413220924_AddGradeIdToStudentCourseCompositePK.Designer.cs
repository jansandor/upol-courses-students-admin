...
namespace cv8_mvc.Migrations
{
    ...
    [Migration("20210413220924_AddGradeIdToStudentCourseCompositePK")]
    partial class AddGradeIdToStudentCourseCompositePK
    {
            ...
            modelBuilder.Entity("cv8_mvc.Models.StudentCourse", b =>
                {
                    ...
                    b.HasKey("StudentId", "CourseId", "CourseStatuteId", "GradeId");
            ...
            modelBuilder.Entity("cv8_mvc.Models.StudentCourse", b =>
                {
                    ...
                    b.HasOne("cv8_mvc.Models.CourseStatute", "CourseStatute")
                        ...
                        .HasForeignKey("cv8_mvc.Models.StudentCourse", "CourseStatuteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("cv8_mvc.Models.Grade", "StudentGrade")
                        .WithOne("StudentCourse")
                        .HasForeignKey("cv8_mvc.Models.StudentCourse", "GradeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
